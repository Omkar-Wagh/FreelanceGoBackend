...
public record ContractDto(int id, String status, OffsetDateTime createdAt, BidDto acceptedBid, JobDto job, ClientDto client, FreelancerDto freelancer,String verificationStatus) {
}
