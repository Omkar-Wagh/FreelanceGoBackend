package com.freelancego.controller.Freelancer;
...
public class BidController {
    ...
    ResponseEntity<BidDto> createBid(@RequestPart("bid") BidDto bidDto, @RequestPart(value = "file", required = false) MultipartFile file, Authentication auth){
