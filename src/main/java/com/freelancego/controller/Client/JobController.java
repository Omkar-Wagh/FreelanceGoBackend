package com.freelancego.controller.Client;
...
public class JobController {
    ...
    @GetMapping("/client/get-post-in-progress")
    ResponseEntity<Map<String,Object>> getDashboardInfo(Authentication auth){
        return ResponseEntity.ok(jobService.getClientDashboardData(auth.getName()));
    }
